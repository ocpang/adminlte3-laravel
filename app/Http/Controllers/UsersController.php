...
class UsersController extends Controller
{
    ...
    {
        $data = User::select('users.*', 'customers.name as customer_name')->with(['customer'])
        ...
        return DataTables::of($data)
            ...
            ->editColumn('customer_name', function ($row) {
                return $row->customer_name == '' ? '-' : ucwords($row->customer_name);
            })
            ->editColumn('status', function ($row) {
                ...
                if($get_role){
                    ...
                    if($role_name == 'admin')
                        ...
                        $role_name = '<span class="badge badge-success">'.ucwords($role_name).'</span>';
                    else if($role_name == 'operational')
                        $role_name = '<span class="badge badge-danger">'.ucwords($role_name).'</span>';
                    else if($role_name == 'reseller')
                        $role_name = '<span class="badge badge-warning">'.ucwords($role_name).'</span>';
                }
    ...
    public function create()
    {
        ...
        return view('user.create', compact('customer', 'role'));
    }
    ...
    public function show(Request $request)
    {
        ...
        $customer_name = "-";
        if(!empty($get_data->customer_id)){
            $customer_name = ucwords($get_data->customer->name);
        }
