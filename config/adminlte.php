        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'  => 'summary',
                    'shift'=> 'ml-3',
                    'icon' => 'fas fa-fw fa-blender-phone',
                    'can'  => 'read summary',
                    'active' => ['summary', 'summary*', 'regex:@^summary/[0-9]+$@'],
                ],
                [
                    'text' => 'callmonitorings',
                    'url'  => 'callmonitoring',
                    'shift'=> 'ml-3',
                    'icon' => 'fas fa-fw fa-server',
                    'can'  => 'read callmonitoring',
                    'active' => ['callmonitoring', 'callmonitoring*', 'regex:@^callmonitoring/[0-9]+$@'],
                ],
            ],
        ],
        ['header' => 'report_menu'],
