									...
									<div class="col-xl-12">
										<div class="row justify-content-center">
											<div class="col-xl-9">
												...
												@endif
												<form id="form_data" role="form" action="{{ route('customer.save') }}" method="POST">
													@csrf
													@method('POST')
													<!--begin::Group-->
													...
													<div class="form-group row fv-plugins-icon-container">
														...
														<div class="col-lg-9 col-xl-9 label_field">
															<input class="form-control form-control-solid form-control-lg" name="label" type="text" maxlength="100" value="">
															<div class="fv-plugins-message-container text-danger"></div>
														</div>
													</div>
													<!--end::Group-->
