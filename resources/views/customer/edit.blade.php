					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header row">
								<div class="col-md-6">Edit Customer</div>
									...
									<div class="col-xl-12">
										<div class="row justify-content-center">
											<div class="col-xl-9">
												...
												@endif
												<form id="form_data" role="form" action="{{ route('customer.save', $customer->id) }}" method="POST">
													@csrf
													@method('POST')
													<input name="id" id="id_data" value="{{$customer->id}}" type="hidden">
													
													<!--begin::Group-->
													<div class="form-group row fv-plugins-icon-container">
														<label class="col-xl-3 col-lg-3 col-form-label">Name*</label>
														<div class="col-lg-9 col-xl-9 name_field">
															<input class="form-control form-control-solid form-control-lg" name="name" type="text" maxlength="100" value="{{ $customer->name }}" readonly>
													...
													<!--begin::Group-->
													<div class="form-group row fv-plugins-icon-container">
														<label class="col-xl-3 col-lg-3 col-form-label">Label</label>
														<div class="col-lg-9 col-xl-9 label_field">
															<input class="form-control form-control-solid form-control-lg" name="label" type="text" maxlength="100" value="{{ $customer->label }}">
															<div class="fv-plugins-message-container text-danger"></div>
														</div>
													</div>
													<!--end::Group-->
			...
			$.ajax({
				...
				success:function(data){
					if(data.status=="success"){
						...
						setTimeout(function(){ window.location.replace("{{ route('customer') }}"); }, 1000);
