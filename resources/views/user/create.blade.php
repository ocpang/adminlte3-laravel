					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header row">
								<div class="col-md-6">Create User</div>
									...
									<div class="col-xl-12">
										<div class="row justify-content-center">
											<div class="col-xl-9">
												...
												@endif
												<form id="form_data" role="form" action="{{ route('user.save') }}" method="POST">
													@csrf
													@method('POST')
													<!--begin::Group-->
													<div class="form-group row fv-plugins-icon-container">
														<label class="col-xl-3 col-lg-3 col-form-label">Type*</label>
														<div class="col-lg-9 col-xl-9 role_id_field">
													...
													<div class="form-group row fv-plugins-icon-container">
														...
														<div class="col-lg-9 col-xl-9 email_field">
													...
													<div class="form-group row fv-plugins-icon-container">
														...
														<div class="col-lg-9 col-xl-9 password_field">
													...
													<div class="form-group row fv-plugins-icon-container">
														...
														<div class="col-lg-9 col-xl-9 password_confirmation_field">
													...
													<!--begin::Group-->
													<div class="form-group row fv-plugins-icon-container" id="customer_id_block" style="display: none;">
														<label class="col-xl-3 col-lg-3 col-form-label">Customer Name*</label>
														<div class="col-lg-9 col-xl-9 customer_id_field">
		...
		$.ajax({
			...
			success:function(data){
				if(data.status=="success"){
					...
					setTimeout(function(){ window.location.replace("{{ route('user') }}"); }, 1000);
